...
ff5 = readtable('./../data/F-F_Research_Data_5_Factors_2x3_daily.CSV');
...
data = readtable('./../data/russell_2000.csv');
...
for i = 1:N
   ...
   X = [ones(T,1), data2.Mkt_RF, data2.RMW, data2.CMA, data2.SMB, data2.HML];
...
Cff5fm = (beta'*cov(X))*beta + diag(var(data2{:,samp_names },0,1)); %VCV
